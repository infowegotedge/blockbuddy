...
$(document).ready(function() {
    ...
    $('.sidebar-condensed.fixed-topbar.fixed-sidebar.theme-sdtl.color-default.dashboard .nav.nav-sidebar > li').on('click', function(event) {
        var ele = $(this);
        $('.nav.nav-sidebar li.active').removeClass('active');
        ele.addClass('active');
    });

    $('.sidebar-condensed.fixed-topbar.fixed-sidebar.theme-sdtl.color-default.dashboard.sidebar-collapsed .nav.nav-sidebar > li.active > ul > li').on('click', function(e) {
        $('.sidebar-condensed.fixed-topbar.fixed-sidebar.theme-sdtl.color-default.dashboard.sidebar-collapsed .nav.nav-sidebar > li.active > ul').hide();
    })
});
