...
import { TradingLedgerComponent } from './trading-ledger.component';
...
describe('TradingLedgerComponent', () => {
  let component: TradingLedgerComponent;
  let fixture: ComponentFixture<TradingLedgerComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ TradingLedgerComponent, TopbarNavComponent, MyStaticsComponent ]
    })
    .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(TradingLedgerComponent);
