...
import { TradingMyPortalComponent } from './trading-my-portal.component';

describe('TradingMyPortalComponent', () => {
  let component: TradingMyPortalComponent;
  let fixture: ComponentFixture<TradingMyPortalComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ TradingMyPortalComponent, TopbarNavComponent, MyStaticsComponent ]
    })
    .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(TradingMyPortalComponent);
