...
class ListTransferWithdraw extends ApiBaseActions {
  ...
  processRequest() {
    ...
    Ledger.listLedgerWithdrawTransfer(auth.id, curPage, perPage, function(e, ledger) {
...
module.exports = (request, reply) => {
  let listTransferWithdraw = new ListTransferWithdraw(request, reply);
  return listTransferWithdraw.processRequest();
}